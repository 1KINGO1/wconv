  ...
  return (
    <div className="text-center">
      ...
      <div className="flex justify-between mt-12 gap-8">
        <FileFormatCard imageUrl="/pdf.png" header="PDF Conversion" description="Convert documents to and from PDF format easily." />
        <FileFormatCard imageUrl="/image.png" header="Image Conversion" description="Change image formats quickly and efficiently." />
        <FileFormatCard imageUrl="/audio.png" header="Audio Conversion" description="Convert audio files to various formats effortlessly." />
      </div>
    </div>
  );
}
